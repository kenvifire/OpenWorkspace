  ...
  if (isLoading) {
    return (
      <div className="p-8 space-y-4">
        <div className="h-10 w-48 animate-pulse rounded-xl bg-[var(--bg-surface)]" />
        <div className="grid grid-cols-3 gap-6">
          <div className="col-span-2 h-64 animate-pulse rounded-2xl bg-[var(--bg-surface)]" />
        ...
        >
          ...
          {projectsLoading ? (
            <div className="space-y-3">
              {[...Array(3)].map((_, i) => <div key={i} className="h-20 animate-pulse rounded-2xl bg-[var(--bg-surface)]" />)}
            </div>
          ) : projects.length === 0 ? (
